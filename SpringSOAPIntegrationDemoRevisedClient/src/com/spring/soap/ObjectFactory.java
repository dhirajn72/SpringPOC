 ...
 * generated in the com.spring.soap package. 
...
public class ObjectFactory {
    ...
    private final static QName _DepositResponse_QNAME = new QName("http://soap.spring.com/", "depositResponse");
    private final static QName _RequestCheckBook_QNAME = new QName("http://soap.spring.com/", "requestCheckBook");
    private final static QName _RequestCheckBookResponse_QNAME = new QName("http://soap.spring.com/", "requestCheckBookResponse");
    private final static QName _Deposit_QNAME = new QName("http://soap.spring.com/", "deposit");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.spring.soap
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.spring.com/", name = "depositResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.spring.com/", name = "requestCheckBook")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.spring.com/", name = "requestCheckBookResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.spring.com/", name = "deposit")
